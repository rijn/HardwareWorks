...
#define nRF24L01_PIN_CSN   GPIO_Pin_6
...
// #define nRF24L01_IRQ_EXTI_LINE                    EXTI_Line12
// #define nRF24L01_IRQ_EXTI_PORT_SOURCE             GPIO_PortSourceGPIOB
// #define nRF24L01_IRQ_EXTI_PIN_SOURCE              GPIO_PinSource12
...
uint8_t SPI2_Tx_Buff[SPI_BUFFER_SIZE];
uint8_t SPI2_Rx_Buff[SPI_BUFFER_SIZE];
...
void nrf24l01DmaConfiguration(void)
{
	...
	DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)nRF24L01_DMA_DR_ADDR;
	DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t)nRF24L01_DMA_RX_ADDR;
	...
	DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)nRF24L01_DMA_DR_ADDR;
	DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t)nRF24L01_DMA_TX_ADDR;
...
void nrf24l01Init(void)
{
...
#if defined nRF24L01_SPI2
	RCC_APB1PeriphClockCmd(nRF24L01_RCC_SPI, ENABLE);
#elif defined nRF24L01_SPI1
	...
	DEBUG_PRINT(nRF24L01_DEBUG_SPI);
