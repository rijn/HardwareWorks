...
#if UART3_FIFO_EN == 1
	bsp_InitUart3(UART3_BAUD);
#endif

#if UART4_FIFO_EN == 1
	bsp_InitUart4(UART4_BAUD);
#endif

#if UART5_FIFO_EN == 1
	bsp_InitUart5(UART5_BAUD);
#endif

#if UART6_FIFO_EN == 1
	bsp_InitUart6(UART6_BAUD, 1);	/* 1表示硬件流控CRS RTS有效;  0表示无需硬件流控 */
#endif
}
...
*********************************************************************************************************
*	函 数 名: bsp_InitUart1
*	功能说明: 配置串口1硬件。  串口1 TX = PA9   RX = PA10 或 TX = PB6   RX = PB7
*	形    参: _uiBaud : 波特率
*	返 回 值: 无
*********************************************************************************************************
*/
void bsp_InitUart1(uint32_t _uiBaud)
{
...
*********************************************************************************************************
*	函 数 名: bsp_InitUart2
*	功能说明: 配置串口2硬件。  串口2 TX = PD5   RX = PD6 或  TX = PA2， RX = PA3
*	形    参: _uiBaud : 波特率
*	返 回 值: 无
*********************************************************************************************************
*/
void bsp_InitUart2(uint32_t _uiBaud)
{
#if UART2_FIFO_EN == 1
	GPIO_InitTypeDef GPIO_InitStructure;
	USART_InitTypeDef USART_InitStructure;
...
*********************************************************************************************************
*	函 数 名: bsp_InitUart3
*	功能说明: 配置串口3硬件。  串口3 TX = PB10   RX = PB11
*	形    参: _uiBaud : 波特率
*	返 回 值: 无
*********************************************************************************************************
*/
void bsp_InitUart3(uint32_t _uiBaud)
{
#if UART3_FIFO_EN == 1
	GPIO_InitTypeDef GPIO_InitStructure;
	USART_InitTypeDef USART_InitStructure;
