...
#include "debug.h"
  ...
  #define UART_DMA_IRQ    DMA1_Channel6_IRQn
  #define UART_DMA_IT_TC  DMA_IT_TC
  #define UART_DMA_CH     DMA1_Channel6

  #define UART_GPIO_PERIF RCC_APB2Periph_GPIOC
  #define UART_GPIO_PORT  GPIOC
  #define UART_GPIO_TX    GPIO_Pin_10
  #define UART_GPIO_RX    GPIO_Pin_11

  #define UART_NVIC_IRQn  USART3_IRQn
